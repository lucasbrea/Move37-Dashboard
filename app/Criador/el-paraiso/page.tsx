...
export default function FirmamentoPage() {
  ...
  const { reports, loading, error, addReport, updateReport, deleteReport } = useReports('criador', 'El Paraiso');
  ...
  return (
    <div className="min-h-screen bg-[#0a192f] text-white p-8">
      <div className="max-w-7xl mx-auto">
        ...
        {/* Page Title */}
        <h1 className="text-4xl font-bold mb-8">El Paraiso</h1>
        ...
        {/* Add Report Button */}
        {!loading && <AddReportButton onAddReport={handleAddReport} criador="El Paraiso" location="criador" />}
