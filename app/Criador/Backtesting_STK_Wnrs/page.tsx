...
export default function BacktestingSTKWnrsPage() {
  ...
  const { reports, loading, error, addReport, updateReport, deleteReport } = useReports('backtesting-stk-winners');
  ...
  return (
    <div className="min-h-screen bg-[#0a192f] text-white p-8">
      <div className="max-w-7xl mx-auto">
        ...
        {/* Add Report Button */}
        {!loading && <AddReportButton onAddReport={handleAddReport} location="backtesting-stk-winners" />}
        ...
        <EditReportModal
          ...
          location="backtesting-stk-winners"
        />
      </div>
    </div>
  );
