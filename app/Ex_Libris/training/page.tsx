...
export default function ExLibrisTrainingPage() {
  const { reports, loading, addReport, updateReport, deleteReport } = useReports('ex-libris-training');
    ...
    <div className="min-h-screen bg-[#0a192f] text-white">
      <div className="max-w-7xl mx-auto px-8 py-12">
        ...
        <div className="flex items-center justify-between mb-12">
          <h1 className="text-4xl font-light tracking-tight">Training</h1>
          <AddReportButton
            onAddReport={handleAddReport}
            location="ex-libris-training"
          />
        </div>
