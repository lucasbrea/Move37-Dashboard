...
export default function Crias20242025Page() {
  const { reports, loading, addReport, updateReport, deleteReport } = useReports('ex-libris-crias-2024-2025');
    ...
    <div className="min-h-screen bg-[#0a192f] text-white">
      <div className="max-w-7xl mx-auto px-8 py-12">
        <nav className="mb-12 flex items-center gap-3 text-sm text-gray-400">
          ...
          <span>/</span>
          <span className="text-white">Crías 2024 & 2025</span>
        </nav>

        <div className="flex items-center justify-between mb-12">
          <h1 className="text-4xl font-light tracking-tight">Crías 2024 & 2025</h1>
          <AddReportButton
            onAddReport={handleAddReport}
            location="ex-libris-crias-2024-2025"
          />
        </div>
