...
export default function PRSDeliveredPage() {
  ...
  const { reports, loading, error, addReport, updateReport, deleteReport } = useReports('crias-prs-delivered');
  ...
  return (
    <div className="min-h-screen bg-[#0a192f] text-white">
      <div className="max-w-7xl mx-auto px-8 py-12">
        ...
        <h1 className="text-5xl font-light mb-16 tracking-tight">PRS Delivered</h1>
        ...
        {/* Add Report Button */}
        {!loading && <AddReportButton onAddReport={handleAddReport} location="crias-prs-delivered" />}
